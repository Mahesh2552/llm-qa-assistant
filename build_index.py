"""Offline script to build the vector index for the old CLI chatbot.

Same logic as the main project, but scoped to this folder:
...
from tqdm import tqdm  # optional, but kept for consistency
...
def main():
    ...
    if not docs:
        raise ValueError("No .txt or .pdf files found in data directory. Add some documents first.")
